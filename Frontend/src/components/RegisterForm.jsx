          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8 text-gray-900 dark:text-gray-300">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input type="text" name="name" id="name" value={formData.name} onChange={handleChange} className="bg-[#2d2d5b] border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#4b4b85] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your full name" required />
              </div>
              <div>
              ...
              <button type="submit" className="w-full text-[#6767e1] bg-[#e0d0f4] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#e0d0f4] dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create an account</button>
